...
<br/>test2:Draw a rotating 3D wooden box
<br/>test3:Draw twenty rotating 3D wooden boxes
<br/>test4:Draw twenty 3D wooden boxes, and only the multiple of three wooden boxes rotation
